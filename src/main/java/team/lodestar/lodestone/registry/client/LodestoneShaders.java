...
public class LodestoneShaders {
    ...
    public static ShaderHolder MANUAL_NINE_SLICE = SHADERS.register(new ShaderHolder(lodestonePath("nineslice/gui/nine_slice"), DefaultVertexFormat.POSITION_TEX));
