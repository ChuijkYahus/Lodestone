...
public class LodestoneVertexFormats {
    ...
    //Scary!!
    public static final VertexFormat POSITION_COLOR_TEX_LIGHTMAP_NORMAL_TANGENT_BITANGENT_UVOFFSET = VertexFormat.builder()
            ...
            .add("UVOffset", VertexFormatElement.UV) // 2 shorts 2*2
            .padding(23) //41 total
            .build();
}
