...
public class SoundHelper {
    ...
    public static void playSoundRandomPitch(Entity target, Supplier<SoundEvent> soundEvent, float minPitch, float maxPitch) {
        playSoundRandomPitch(target, soundEvent.get(), minPitch, maxPitch);
    }

    public static void playSoundRandomPitch(Entity target, Supplier<SoundEvent> soundEvent, float volume, float minPitch, float maxPitch) {
    ...
    public static void playSound(Entity target, Supplier<SoundEvent> soundEvent, float volume, float pitch) {
